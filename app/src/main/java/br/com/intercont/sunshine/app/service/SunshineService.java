...
public class SunshineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        //trazendo o location dos extras da Intent ao trabalhar com Services
    ...
    public void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                this.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, resultCV);
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        retCursor = this.getContentResolver().query(
